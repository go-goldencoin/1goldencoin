...
uint256 hashGenesisBlock("0x734aec1d4f3104123a41709e2f36c40a097b65a199586106f3a256d500a92e82");
...
bool LoadBlockIndex()
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0x3084ae438d415261dd86b555fdd8eb1f2d5d6ee5f24e9e1b40ab1a7eb29db1fe");
    }
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        ...
        // Genesis block
        const char* pszTimestamp = "Forkast.News 19/July/2021 E-CNY white paper released; Malaysia steamrolls mining rigs";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        txNew.vin[0].scriptSig = CScript() << 486604799 << CBigNum(4) << vector<unsigned char>((const unsigned char*)pszTimestamp, (const unsigned char*)pszTimestamp + strlen(pszTimestamp));
        txNew.vout[0].nValue = .12 * COIN;
        txNew.vout[0].scriptPubKey = CScript() << ParseHex("04d080b6014ad81ce257518e3e642a2811dc79d9cf340fc982642f1a60993e0a8ee0bcd0cc4903f3658c59f2f8cd5ceea9953cef3f95dd201a48ca8fe1a67f2322") << OP_CHECKSIG;
        CBlock block;
        block.vtx.push_back(txNew);
        block.hashPrevBlock = 0;
        block.hashMerkleRoot = block.BuildMerkleTree();
        block.nVersion = 1;
        block.nTime    = 1626737856;
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 2089915635;

        if (fTestNet)
        {
            block.nTime    = 1626737859;
            block.nNonce   = 385753320;
        }
...
if (true && block.GetHash() != hashGenesisBlock)
        ...
        assert(block.hashMerkleRoot == uint256("0xb41bae5b67b0b404618bfa66c5447de675c66d4fe0d801fc2cfc0658a951a09e"));
        block.print();
...
unsigned char pchMessageStart[4] = { 0xfd, 0xcc, 0xb2, 0xd0 }; // Goldencoin: increase each by adding 2 to bitcoin's value.
